        ...
        <li class="nav-item">
            ...
            <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                <div class="bg-white py-2 collapse-inner rounded">
                    ...
                    <a class="collapse-item" href="/cust/get">ALL</a>
                </div>
            </div>
        </li>
                        ...
                        <c:when test="${loginadm == null}">
                            <li class="nav-item no-arrow">
                                <a href="/login" role="button">
                                    <span class ="mr-2 done d-lg-inline text-gray-600 small">Login</span>
                                </a>
                            </li>
                            <li class="nav-item no-arrow">
                                <a href="/register" role="button">
                                    <span class ="mr-2 done d-lg-inline text-gray-600 small">Register</span>
                                </a>
                            </li>
                        </c:when>
                        <c:otherwise>
